...
const handleTiktokLogin = () => {
  ...
  const authUrl = `https://www.tiktok.com/v2/auth/authorize?client_key=${clientKey}&response_type=code&scopes=user.info.basic&redirect_uri=${encodeURIComponent(window.location.origin)}&state=${state}`
