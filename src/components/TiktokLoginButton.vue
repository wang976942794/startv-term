...
const handleTiktokLogin = () => {
  ...
  const authUrl = `https://www.tiktok.com/v2/auth/authorize?client_key=${clientKey}&response_type=code&scope=user.info.basic,user.info.profile&redirect_uri=${encodeURIComponent(window.location.origin)}&state=${state}`
